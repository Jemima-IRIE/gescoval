...
/**
 * Script de Seeding Complet pour la base de données Gescoval.
 *
...
function seedUsers(ServiceAuthentication $authService): void
{
    ...
    $usersToCreate = [
        [
            ...
            'user_data' => ['login_utilisateur' => 'admin_sys', 'email_principal' => 'admin.sys@gescoval.dev', 'mot_de_passe' => $defaultPassword, 'id_niveau_acces_donne' => 'ACCES_TOTAL', 'id_groupe_utilisateur' => 'GRP_ADMIN_SYS'],
            'profile_data' => ['nom' => 'Système', 'prenom' => 'Admin']
        ],
        [
            'type_code' => 'TYPE_PERS_ADMIN',
            'user_data' => ['login_utilisateur' => 'resp_sco', 'email_principal' => 'resp.sco@gescoval.dev', 'mot_de_passe' => $defaultPassword, 'id_niveau_acces_donne' => 'ACCES_DEPARTEMENT', 'id_groupe_utilisateur' => 'GRP_RS'],
            'profile_data' => ['nom' => 'Scolarité', 'prenom' => 'Responsable', 'telephone_professionnel' => '0123456789']
        ],
        [
            'type_code' => 'TYPE_PERS_ADMIN',
            'user_data' => ['login_utilisateur' => 'agent_conf', 'email_principal' => 'agent.conf@gescoval.dev', 'mot_de_passe' => $defaultPassword, 'id_niveau_acces_donne' => 'ACCES_DEPARTEMENT', 'id_groupe_utilisateur' => 'GRP_AGENT_CONFORMITE'],
            'profile_data' => ['nom' => 'Conformité', 'prenom' => 'Agent', 'telephone_professionnel' => '0123456788']
        ],
        [
            'type_code' => 'TYPE_ENS',
            'user_data' => ['login_utilisateur' => 'prof_dupont', 'email_principal' => 'prof.dupont@gescoval.dev', 'mot_de_passe' => $defaultPassword, 'id_niveau_acces_donne' => 'ACCES_DEPARTEMENT', 'id_groupe_utilisateur' => 'GRP_COMMISSION'],
            'profile_data' => ['nom' => 'Dupont', 'prenom' => 'Jean', 'telephone_professionnel' => '0611223344']
        ],
        [
            'type_code' => 'TYPE_ETUD',
            'user_data' => ['login_utilisateur' => 'etu_martin', 'email_principal' => 'etu.martin@gescoval.dev', 'mot_de_passe' => $defaultPassword, 'id_niveau_acces_donne' => 'ACCES_PERSONNEL', 'id_groupe_utilisateur' => 'GRP_ETUDIANT'],
