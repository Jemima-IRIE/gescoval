...
INSERT INTO `parametres_systeme` (`cle`, `valeur`, `description`, `type`) VALUES
                                                                              ...
                                                                              ('SMTP_FROM_EMAIL', 'no-reply@gescoval.com', 'Adresse email de l\'expéditeur par défaut.', 'string'),
                                                                              ('SMTP_FROM_NAME', 'GesCoVal', 'Nom de l\'expéditeur par défaut.', 'string'),
...
INSERT INTO `utilisateur` (`numero_utilisateur`, `login_utilisateur`, `email_principal`, `mot_de_passe`, `date_creation`, `derniere_connexion`, `token_reset_mdp`, `date_expiration_token_reset`, `token_validation_email`, `email_valide`, `tentatives_connexion_echouees`, `compte_bloque_jusqua`, `preferences_2fa_active`, `secret_2fa`, `photo_profil`, `statut_compte`, `id_niveau_acces_donne`, `id_groupe_utilisateur`, `id_type_utilisateur`) VALUES
                                                                                                                                                                                                                                                                                                                                                                                                                                                           ('ADM-2025-0001', 'resp_sco', 'resp.sco@gescoval.dev', '$2y$10$LDuzMmrtuMbEqttVvPYU1uSktwQqdN90QDtHDupQ1Kl/I/8i0USbC', '2025-06-25 15:14:10', NULL, NULL, NULL, '97e6ef85e67dcd66490fa09ec9d4b8fc0ca078ace86f8e735473f2f1a3d4581d', 0, 0, NULL, 0, NULL, NULL, 'actif', 'ACCES_DEPARTEMENT', 'GRP_PERS_ADMIN', 'TYPE_PERS_ADMIN'),
                                                                                                                                                                                                                                                                                                                                                                                                                                                           ('ADM-2025-0002', 'agent_conf', 'agent.conf@gescoval.dev', '$2y$10$gBN1V1WXin91Xu.JCnIFEO6q1Arp59VBN74BzcFrAh1G2iaL.4DA2', '2025-06-25 15:14:10', NULL, NULL, NULL, '791236265f9efb7db230137992b3e235dbe8b33ef35a4bd0096fc0f971b8ccaf', 0, 0, NULL, 0, NULL, NULL, 'actif', 'ACCES_DEPARTEMENT', 'GRP_PERS_ADMIN', 'TYPE_PERS_ADMIN'),
                                                                                                                                                                                                                                                                                                                                                                                                                                                           ('ENS-2025-0001', 'prof_dupont', 'prof.dupont@gescoval.dev', '$2y$10$h9nEwZdBepRRQedg1tuvJujjrdmZ2jBgaAMc/r9dbDjjKMRg66dJq', '2025-06-25 15:14:10', NULL, NULL, NULL, 'daa4318f9c7a1322c4ec4840f02bbd590d1c26ba79baedc99dcd03d76bc3d0c6', 0, 0, NULL, 0, NULL, NULL, 'actif', 'ACCES_DEPARTEMENT', 'GRP_ENSEIGNANT', 'TYPE_ENS'),
                                                                                                                                                                                                                                                                                                                                                                                                                                                           ('ETU-2025-0001', 'etu_martin', 'etu.martin@gescoval.dev', '$2y$10$64kSHQbLa9cEe3hXJ0RDHOVdOrkW9CTQjOYaghSOHsziy16BXog2i', '2025-06-25 15:14:10', NULL, NULL, NULL, '977ec8fa3bee1590f68e02a3e5c2fb1212d2aac484ae1d4d11fb19d85cacd124', 0, 0, NULL, 0, NULL, NULL, 'actif', 'ACCES_PERSONNEL', 'GRP_ETUDIANT', 'TYPE_ETUD'),
                                                                                                                                                                                                                                                                                                                                                                                                                                                           ('SYS-2025-0001', 'admin_sys', 'admin.sys@gescoval.dev', '$2y$10$Yz7cffYIpq574/BIed87R.UV85F.GG9VNF0JOX4bTcs/kTBOxeOQC', '2025-06-25 15:14:10', '2025-06-26 19:36:01', NULL, NULL, 'e8eb0345a1ea3f8858d2f0396a3efae8552dcb469d6a3a6b1c69a3cd523577fc', 1, 0, NULL, 0, NULL, NULL, 'actif', 'ACCES_TOTAL', 'GRP_ADMIN_SYS', 'TYPE_ADMIN');
