// Public/assets/css/gescoval-dashboard.js
document.addEventListener('DOMContentLoaded', function () {
    ...
    function generateMockData() {
        ...
        mockEmailTemplates = [ // Table Message
            { id_message: 'EMAIL_COMPTE_CREE', sujet_message: 'Votre compte GesCoVal a été créé', libelle_message: 'Cher {{prenom}} {{nom}}, ...', type_message: 'EMAIL_CREATION_COMPTE' },
        ...
        mockAppSettings = {
            ...
            smtp_port: 587,
            admin_email_contact: 'admin@gescoval.com'
        };
