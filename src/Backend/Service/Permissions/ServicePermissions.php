...
class ServicePermissions implements ServicePermissionsInterface
{
    ...
    public function getPermissionsForUser(string $userId): array
    {
        $permissions = [];
        try {
            // 1. Récupérer l'ID de groupe de l'utilisateur depuis la table 'utilisateur' [cite: uploaded:Jemima-IRIE/gescoval/GesCoVal-24b2b01d2b765035009d2a7af2249c0f12c911ab/gescoval.sql]
            ...
            if ($user && isset($user['id_groupe_utilisateur'])) {
                ...
                // 2. Récupérer tous les traitements associés à ce groupe via la table 'rattacher', [cite: uploaded:Jemima-IRIE/gescoval/GesCoVal-24b2b01d2b765035009d2a7af2249c0f12c911ab/gescoval.sql]
                // et toutes les informations pertinentes de la table 'traitement' [cite: uploaded:Jemima-IRIE/gescoval/GesCoVal-24b2b01d2b765035009d2a7af2249c0f12c911ab/gescoval.sql]
