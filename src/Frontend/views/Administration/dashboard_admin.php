...
<script>
    ...
    // Pour l'exemple, `gestioncoval-dashboard.js` est censé contenir ces logiques.

    // Cette fonction pourrait être appelée par `gescoval-dashboard.js`
    ...
    function initAdminDashboard() {
        ...
        // (La logique du header est dans header.php et gescoval-dashboard.js)
